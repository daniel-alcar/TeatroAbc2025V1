...
public class LeitorEstatistica {
    ...
    public static DefaultTableModel lerArquivo(String estatisticas) throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("TeatroAbc2025V1\\estatisticas.txt"))) {
            String linha;
